...
# Process remaining files in other directories
for dir in docs/build docs/integrations docs/testing docs/tools docs/ui docs/improvements; do
    if [[ -d "$dir" ]]; then
...
echo "All remaining files improved!"
