import { claudeCodeDefaultModelId, claudeCodeModels, getClaudeCodeModelId, } from "@roo-code/types";
...
export class ClaudeCodeHandler extends BaseProvider {
    ...
    async *createMessage(systemPrompt, messages) {
        ...
        const modelId = model.id in claudeCodeModels ? model.id : claudeCodeDefaultModelId;
    ...
    getModel() {
        ...
        if (modelId && modelId in claudeCodeModels) {
            const id = modelId;
            const modelInfo = { ...claudeCodeModels[id] };
        ...
        const defaultModelInfo = { ...claudeCodeModels[claudeCodeDefaultModelId] };
        // Override maxTokens with the configured value if provided
        if (this.options.claudeCodeMaxOutputTokens !== undefined) {
