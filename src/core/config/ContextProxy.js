...
import { PROVIDER_SETTINGS_KEYS, GLOBAL_SETTINGS_KEYS, SECRET_STATE_KEYS, GLOBAL_STATE_KEYS, GLOBAL_SECRET_KEYS, providerSettingsSchema, globalSettingsSchema, isSecretStateKey, } from "@roo-code/types";
...
export class ContextProxy {
     ...
     * WorkspaceState
     */
    async updateWorkspaceState(context, key, value) {
        await context.workspaceState.update(key, value);
    }
    async getWorkspaceState(context, key) {
