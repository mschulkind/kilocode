...
export function getToolUseGuidelinesSection(codeIndexManager?: CodeIndexManager): string {
  ...
  - Any other relevant feedback or information related to the tool use.`)
	...
	4. Workspace-level custom mode files provided by the user (for example: `.kilocodemodes` in the repo or `globalStorage/.../custom_modes.yaml`). These override built-in modes for this workspace.
