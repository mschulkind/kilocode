...
import type { ExtensionMessage, ExtensionState, MarketplaceInstalledMetadata } from "../../shared/ExtensionMessage.js"
import { Mode, defaultModeSlug, getModeBySlug } from "../../shared/modes.js"
...
import { EMBEDDING_MODEL_PROFILES } from "../../shared/embeddingModels.js"
import { ProfileValidator } from "../../shared/ProfileValidator.js"
...
import WorkspaceTracker from "../../integrations/workspace/WorkspaceTracker.js"

import { McpHub } from "../../services/mcp/McpHub.js"
import { McpServerManager } from "../../services/mcp/McpServerManager.js"
import { MarketplaceManager } from "../../services/marketplace.js"
import { ShadowCheckpointService } from "../../services/checkpoints/ShadowCheckpointService.js"
import { CodeIndexManager } from "../../services/code-index/manager.js"
import type { IndexProgressUpdate } from "../../services/code-index/interfaces/manager.js"
import { MdmService } from "../../services/mdm/MdmService.js"

import { fileExistsAtPath } from "../../utils/fs.js"
import { setTtsEnabled, setTtsSpeed } from "../../utils/tts.js"
import { getWorkspaceGitInfo } from "../../utils/git.js"
import { getWorkspacePath } from "../../utils/path.js"
import { OrganizationAllowListViolationError } from "../../utils/errors.js"

import { setPanel } from "../../activate/registerCommands.js"

import { t } from "../../i18n.js"

import { buildApiHandler } from "../../api.js"
import { forceFullModelDetailsLoad, hasLoadedFullDetails } from "../../api/providers/fetchers/lmstudio.js"

import { ContextProxy } from "../config/ContextProxy.js"
import { getEnabledRules } from "./kilorules.js"
import { ProviderSettingsManager } from "../config/ProviderSettingsManager.js"
import { CustomModesManager } from "../config/CustomModesManager.js"
import { Task } from "../task/Task.js"
import { getSystemPromptFilePath } from "../prompts/sections/custom-system-prompt.js"
...
import { McpDownloadResponse, McpMarketplaceCatalog } from "../../shared/kilocode/mcp.js"
import { McpServer } from "../../shared/mcp.js"
import { OpenRouterHandler } from "../../api/providers.js"
import { stringifyError } from "../../shared/kilocode/errorUtils.js"
import isWsl from "is-wsl"
import { getKilocodeDefaultModel } from "../../api/providers/kilocode/getKilocodeDefaultModel.js"
import { getKiloCodeWrapperProperties } from "../../core/kilocode/wrapper.js"
