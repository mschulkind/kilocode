...
describe("keybindings", () => {
    ...
    describe("getKeybindingForCommand", () => {
        ...
        it("should throw error when unable to read keybindings file", async () => {
            ...
            await expect(getKeybindingForCommand("test.command")).rejects.toThrow("Unable to read keybindings file: File not found");
        });
    });
    ...
    describe("getKeybindingsForCommands", () => {
        ...
        it("should throw error for commands without keybindings", async () => {
            ...
            await expect(getKeybindingsForCommands(["test.command1", "test.command2"])).rejects.toThrow("Command 'test.command2' not found in package.json keybindings");
        });
    });
