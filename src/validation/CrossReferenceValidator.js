...
export class CrossReferenceValidator {
	...
	handleCommonPatterns(filePath, currentFilePath) {
		...
		const commonMappings = {
			...
			"README.md": resolve(process.cwd(), "docs/README.md"),
			"../README.md": resolve(process.cwd(), "docs/README.md"),

			// Common architecture references
			"architecture/README.md": resolve(process.cwd(), "docs/architecture/README.md"),
			"../architecture/README.md": resolve(process.cwd(), "docs/architecture/README.md"),

			// Common standards references
			"standards/README.md": resolve(process.cwd(), "docs/standards/README.md"),
			"../standards/README.md": resolve(process.cwd(), "docs/standards/README.md"),
		}

		// Check if the file path matches any common patterns
		if (commonMappings[filePath]) {
			return commonMappings[filePath]
		}

		// Handle patterns with current file context
		if (currentFilePath) {
			const currentDir = path.dirname(currentFilePath)

			// If referencing GLOSSARY.md from any docs subdirectory
			if (filePath === "GLOSSARY.md" && currentDir.includes("docs")) {
				return resolve(process.cwd(), "docs/GLOSSARY.md")
			}

			// If referencing README.md from any docs subdirectory
			if (filePath === "README.md" && currentDir.includes("docs")) {
				return resolve(process.cwd(), "docs/README.md")
			}
		}
