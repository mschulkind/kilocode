...
export class ValidationRuleConfig {
     ...
     */
    getRulesForDocument(filePath, content, structure) {
     ...
     */
    getRuleValue(filePath, content, structure, ruleName) {
     ...
     */
    isRuleEnabled(filePath, content, structure, ruleName) {
        const rules = this.getRulesForDocument(filePath, content, structure);
        const rule = rules[ruleName];
     ...
     */
    applyDynamicRules(baseRules, filePath, content, structure, typeResult) {
     ...
     */
    generateCacheKey(filePath, content, structure) {
