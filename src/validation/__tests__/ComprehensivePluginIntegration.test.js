...
describe("Comprehensive Plugin Integration", () => {
    let mockCrossReferenceValidator;
    let mockFileIndexBuilder;
    let mockDocumentTypeDetector;
    let mockOrphanedSectionsDetector;
    let mockValidationRuleConfig;
    beforeEach(() => {
        // Reset all mocks
        vi.clearAllMocks();
        ...
        CrossReferenceValidator.mockImplementation(() => mockCrossReferenceValidator);
        ...
        FileIndexBuilder.mockImplementation(() => mockFileIndexBuilder);
        ...
        DocumentTypeDetector.mockImplementation(() => mockDocumentTypeDetector);
        ...
        OrphanedSectionsDetector.mockImplementation(() => mockOrphanedSectionsDetector);
        ...
        ValidationRuleConfig.mockImplementation(() => mockValidationRuleConfig);
    });
    afterEach(() => {
        vi.restoreAllMocks();
    });
...
//# sourceMappingURL=ComprehensivePluginIntegration.test.js.map