...
describe("ValidationRuleConfig", () => {
    ...
    describe("updateRuleSet", () => {
        ...
        it("should validate rule set structure", () => {
            ...
            expect(() => {
                config.updateRuleSet("invalid", invalidRules);
            }).toThrow();
        });
    });
    ...
    describe("dynamic rule application", () => {
        it("should apply rules based on document content", () => {
            const longContent = "This is a very long line of content that exceeds the normal line length limit and should trigger different validation rules.";
            mockDocumentTypeDetector.detectType.mockReturnValue({
                type: "general",
                confidence: 0.8,
...
//# sourceMappingURL=ValidationRuleConfig.test.js.map